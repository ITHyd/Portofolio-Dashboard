...
class Project(Base):
    ...
    current_milestone: Mapped[str | None] = mapped_column(String(255))
    current_milestone_due: Mapped[date | None] = mapped_column(Date)
    current_milestone_status: Mapped[str | None] = mapped_column(String(32))
