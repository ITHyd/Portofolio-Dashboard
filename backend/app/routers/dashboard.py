        ...
        project_health.append(
            {
                ...
                "weekly_update": s.weekly_update if s else None,
                "update_date": s.update_date.isoformat() if s and s.update_date else None,
                "delivery_lead": s.delivery_lead if s else None,
